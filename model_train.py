def model_train(img_width, img_height, top_model_weights_path, train_data_dir, 
	...
	np.save('model_predictor/bottleneck_features_train.npy', bottleneck_features_train)
	# ------------------------------------------------------------------------------  
	...
	np.save('model_predictor/bottleneck_features_validation.npy', bottleneck_features_validation)
	# ------------------------------------------------------------------------------  
	...
	train_data = np.load('model_predictor/bottleneck_features_train.npy')  
	...
	validation_data = np.load('model_predictor/bottleneck_features_validation.npy')  
